/* Bento
 *
 * $Id: ParsedDynamicBentoBlock.java,v 1.3 2005/06/30 04:20:55 sthippo Exp $
 *
 ...
 */
public class ParsedDynamicBentoBlock extends DynamicBentoBlock {

    public ParsedDynamicBentoBlock(int id) {
        super();
    }
