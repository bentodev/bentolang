/* Bento
 *
 * $Id: BentoCompiler.java,v 1.14 2015/06/15 13:18:24 sthippo Exp $
...
public class BentoCompiler {
	...
	public static void main( String args[] ) {
		if ( args.length == 0 ) {
			...
			BentoCompiler bc = new BentoCompiler();
			bc.compile( args );
		}
	}
	...
	private static void showHelp() {
		System.out.println( "\nUsage:\n        java bentoc [options] sourcepath[:sourcepath...] [pagename]" );
		//System.out.println( "\n   or:\n        java -jar bento.jar [options] sourcepath[:sourcepath...]" );
		...
		System.out.println( "               files that match the filter (default: *.bento)" );
	...
	void compile( String args[] ) {
		...
		SiteLoader loader = new SiteLoader(core, "", bentoPath, inFilter, recursive, options);
		loader.load();
