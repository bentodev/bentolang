/* Bento
 *
 * $Id: Logger.java,v 1.33 2015/04/20 12:50:41 sthippo Exp $
 *
...
public class Logger implements BentoParserVisitor {
    ...
    public static String getDescription(AbstractNode node) {
        ...
        if (node instanceof Type) {
            ...
            BentoNode reference = ((Instantiation) node).getReference();
            ...
            desc = "CONSTRUCTION";
        } else if (node instanceof BentoStatement) {
            desc = "STATEMENT";
    ...
    private void logNodeInfo(BentoNode bentoNode) {
    	AbstractNode node = (AbstractNode) bentoNode;
    ...
    protected Object handleNode(BentoNode node, Object data) {
        logNodeInfo(node);
    ...
    public Object visit(BentoNode node, Object data) {
        logIfVerbose("BentoNode!!!");
        return data;
    }
    ...
    public Object visit(ParsedBentoBlock node, Object data) {
        logIfVerbose("BentoBlock:");
        return handleNode(node, data);
    }
    ...
    public Object visit(ParsedDynamicBentoBlock node, Object data) {
        logIfVerbose("DynamicBentoBlock:");
        return handleNode(node, data);
    }
    public Object visit(ParsedConcurrentBentoBlock node, Object data) {
        logIfVerbose("ConcurrentBentoBlock:");
        return handleNode(node, data);
    }
    ...
    public Object visit(ParsedInsertStatement node, Object data) {
        logIfVerbose("InsertStatement:");
        return handleNode(node, data);
    }
    ...
    public Object visit(ParsedOverConstruction node, Object data) {
        logIfVerbose("OverConstruction:");
        return handleNode(node, data);
    }
    public Object visit(ParsedUnderConstruction node, Object data) {
        logIfVerbose("UnderConstruction:");
        return handleNode(node, data);
    }
    ...
    public Object visit(ParsedArrayIndex node, Object data) {
        logIfVerbose("ArrayIndex:");
        return handleNode(node, data);
    }
    public Object visit(ParsedTableIndex node, Object data) {
        logIfVerbose("TableIndex:");
        return handleNode(node, data);
    }
