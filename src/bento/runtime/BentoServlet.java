/* Bento
 *
 * $Id: BentoServlet.java,v 1.37 2014/11/01 19:49:43 sthippo Exp $
 *
...
public class BentoServlet extends BentoServer {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
        	...
        	throw new ServletException("Exception initializing BentoServer", e);
        }
    ...
    protected void respond(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        if (site == null || exception != null) {
            out.println("<head><title>Bento Error</title></head>");
            out.println("<body BGCOLOR=\"#88ccbb\">");
            if (site == null) {
                out.println("<h2>Unable to load Bento site</h2>");
                if (exception != null) {
                ...
                out.println("<p>Bento site: " + site.getName() + "</p>");
        ...
        out.println("<li>bentopath: " + getBentoPath() + "</li>");
    ...
    private void respondWithFile(File file, BentoSite site, HttpServletResponse response) throws ServletException, IOException {
