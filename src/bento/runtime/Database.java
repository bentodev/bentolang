...
/**
 * Supports basic database access by Bento code.
 *
...
public class Database {
    ...
    public class ResolvedRecordCollection extends ResolvedCollection {
        ...
        public ResolvedRecordCollection(RecordCollectionDefinition recDef, Context context, ArgumentList args, List<Index> indexes) throws Redirection {
            ...
            Definition defInCache = (recs != null ? context.getDefinition(name, fullName, args) : null);
            if (recs == null || !recDef.equals(defInCache)) {
...
//                        table = new HashMap((Map) contents);
    ...
    public BentoArray query(String sql, Object[] fields) throws Redirection {
        try {
    ...
    public BentoArray query(String sql) throws Redirection {
        try {
    ...
    public BentoArray query(String sql, String count_sql) throws Redirection {
        try {
