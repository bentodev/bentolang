/* Bento
 *
 * $Id: Exec.java,v 1.13 2015/01/05 03:57:04 sthippo Exp $
 *
...
/**
 * Class for executing OS commands from Bento.
 *
...
public class Exec {
    ...
    public static Exec execFactory(String command, Object envObj, Object dirObj) {
        ...
        } else if (dirObj instanceof BentoFile) {
            return new Exec(command, (Map<String, String>) envObj, (BentoFile) dirObj);
    ...
    public Exec(String command, Map<String, String> env, BentoFile dir) {
