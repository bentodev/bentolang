/* Bento
 *
 * $Id: Dim.java,v 1.10 2015/04/13 13:09:10 sthippo Exp $
 *
...
public class Dim extends AbstractNode {
     ...
     *  is returned.  If the object is an array or a non-growable BentoArray, the 
     *  type of the returned Dim will be DEFINITE, otherwise it will be INDEFINITE.
     *  If the object is not a Map, Collection, BentoArray or array, null 
     *  is returned.
     */
    public static Dim createForObject(Object obj) {
        ...
        if (obj != null) {
            if (obj instanceof Map<?,?>) {
                ...
                TYPE type = ((BentoArray) obj).isGrowable() ? TYPE.INDEFINITE : TYPE.DEFINITE;
                dim = new Dim(type, ((BentoArray) obj).getSize());
