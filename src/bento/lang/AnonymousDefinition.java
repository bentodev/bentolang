...
public class AnonymousDefinition extends BentoStatement implements Definition {
    ...
    public List<Object> instantiate_array(bento_context context) throws Redirection {
    ...
    public Map<String, Object> instantiate_table(bento_context context) throws Redirection {
    ...
    public Map<String, Definition> defs() {
        ...
        if (node instanceof Definition) {
            ...
            if (nodeList.size() > 0) {
                ...
                while (it.hasNext()) {
                    BentoNode child = (BentoNode) it.next();
    ...
    public boolean isAbstract(Context context) {
        BentoNode contents = getContents();
    ...
    /** Construct this definition without arguments in the specified bento_context, 
     *  which is available to bento code via the runtime reflection api.
     */
    ...
    public Object instantiate(bento_context context) throws Redirection {
        return instantiate(context.getContext());
    }
    
    /** Construct this definition with the specified arguments in the specified 
     *  bento_context, which is available to bento code via the runtime reflection api.
     */
    public Object instantiate(Context context, ArgumentList args) throws Redirection {
        return instantiate(args, null, context); 
    }

    public Object instantiate(bento_context context, ArgumentList args) throws Redirection {
     ...
     *  is the Bento supertype of the external object.
     **/
            ...
            if (childDef == null) {
                if (type != null && type.getName().equals("definition")) {
                    ...
                    if (cName.equals("defs") || cName.equals("descendants_of_type") || cName.equals("full_name")) {
                        ExternalDefinition externalDef = new ExternalDefinition("bento.lang.AnonymousDefinition", getParent(), getOwner(), type, getAccess(), DYNAMIC, this, null);
