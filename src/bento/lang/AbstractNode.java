/* Bento
 *
 * $Id: AbstractNode.java,v 1.28 2015/02/09 14:33:44 sthippo Exp $
 *
...
import bento.compiler.visitor.BentoCompilerVisitDestination;
import bento.parser.BentoParserConstants;
import bento.parser.BentoParserVisitor;
...
/**
 * AbstractNode is the base class for bento nodes.  Nodes are either primitive
 ...
 * of the bento document.  The namespace hierarchy consists of the top-level site
 ...
 *
 * AbstractNode implements both the BentoNode interface, which is used by classes in
 * the bento.lang package, and the Node interface, which is used by classes generated
 * by javacc and jjtree.
 *
 * @author Michael St. Hippolyte
 * @version $Revision: 1.28 $
 */
abstract public class AbstractNode extends BentoCompilerVisitDestination implements BentoNode, Node, Cloneable {
    ...
    public Iterator<BentoNode> getChildren() {
        if (children == null || children.length == 0) {
            return new NullIterator<BentoNode>();
        } else {
            return Arrays.asList((BentoNode[]) children).iterator();
        }
    }

    public List<BentoNode> getChildList() {
        if (children == null || children.length == 0) {
            return new EmptyList<BentoNode>();
        } else {
            return Arrays.asList((BentoNode[]) children);
        }
    }
...
//            }
                    ...
                    if (t.next != null) {
                        switch (t.next.kind) {
                            ...
                            case BentoParserConstants.RCURLY:
                                break;
                            case BentoParserConstants.ADOPT:
                            case BentoParserConstants.CACHE:
    ...
    public Object jjtAccept(BentoParserVisitor visitor, Object data) {
        ...
        //System.out.println("jjtAccept on this class (BentoNode) should never be called!");
        return data;
    }

    /** Accept the visitor. **/
    public Object childrenAccept(BentoParserVisitor visitor, Object data) {
        if (children != null) {
            for (int i = 0; i < children.length; i++) {
